...
class processGame extends Game
{
	 ...
	 */
	public static function create($variantID, $name, $password, $bet, $potType, $phaseMinutes, $joinPeriod, $anon, $press, $maxTurns, $targetSCs, $minRating, $minPhases, $specialCDturn, $specialCDcount)
	{
		global $DB;
