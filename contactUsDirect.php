...
else
{
    ...
    <p> Need something else? Take a look at our <a href="contactUs.php" class="contactUs">Contact Info</a> page to learn how to contact an owner and see all the problems moderators can help with!</p>
    </div>';
