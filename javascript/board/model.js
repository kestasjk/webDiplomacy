...
function loadModel() {
  ...
  function snapTogether(startArr, snapOnArr) {
    for (var i = 0; i < snapOnArr.length; i++) startArr.push(snapOnArr[i]);
  ...
  TerritoryClass.prototype = {
    ...
    getBorderTerritories: function () {
      ...
      if (Object.isUndefined(this.getBorderTerritoriesCache))
        this.getBorderTerritoriesCache = this.Borders.pluck("id")
          .compact()
          .map(function (n) {
    ...
    getBorderUnits: function () {
      ...
      if (Object.isUndefined(this.getBorderUnitsCache))
        this.getBorderUnitsCache = this.coastParent
  ...
  UnitClass.prototype = {
    ...
    canMoveInto: function (TryMoveTerritory) {
      if (
        this.getMovableTerritories()
          .pluck("coastParent")
          .pluck("id")
          .member(TryMoveTerritory.coastParent.id)
      )
        return true;
      else return false;
    },
    ...
    canConvoyTo: function (TryConvoyTerritory) {
      if (this.type == "Army") {
        ...
        if (
          this.convoyLink &&
          TryConvoyTerritory.convoyLink &&
          this.ConvoyGroup.Coasts.member(TryConvoyTerritory)
        )
          return true;
      }
    ...
    canCrossBorder: function (b) {
      if (this.type == "Army" && !b.a) return false;
      else if (this.type == "Fleet" && !b.f) return false;
      else return true;
    },
    ...
    getMovableTerritories: function () {
      if (Object.isUndefined(this.getMovableTerritoriesCache))
        this.getMovableTerritoriesCache = this.Territory.CoastalBorders.select(
          this.canCrossBorder,
          this
        )
          .pluck("id")
    ...
    getReachableTerritories: function () {
      if (Object.isUndefined(this.getReachableTerritoriesCache)) {
        ...
        if (this.convoyLink && this.type == "Army")
          this.getReachableTerritoriesCache = snapTogether(
            this.getReachableTerritoriesCache,
            this.ConvoyGroup.Coasts.select(this.canConvoyTo, this)
          ).uniq();
      }
    ...
    getMovableUnits: function () {
      if (Object.isUndefined(this.getMovableUnitsCache))
        this.getMovableUnitsCache = this.getMovableTerritories()
          .pluck("coastParent")
          .pluck("Unit")
          .compact();
  ...
  if (context.phase == "Diplomacy") {
    ...
    UnitClass = Class.create(UnitClass, {
      ...
      getMoveChoices: function () {
        ...
        if (this.convoyLink && this.type == "Army") {
          this.convoyOptions = this.ConvoyGroup.Coasts.select(
            this.canConvoyTo,
            this
          ).pluck("id");
      ...
      getSupportMoveFromChoices: function (AgainstTerritory) {
        ...
        if (AgainstTerritory.convoyLink) {
          ...
          if (
            ...
            ConvoyArmies = AgainstTerritory.ConvoyGroup.Armies.select(function (
              ConvoyArmy
            ) {
              var path =
                AgainstTerritory.ConvoyGroup.pathArmyToCoastWithoutFleet(
                  ConvoyArmy.Territory,
                  AgainstTerritory,
                  this.Territory
                );
              if (Object.isUndefined(path)) return false;
              else return true;
            },
            this);
          } else {
        ...
        return PossibleUnits.pluck("Territory")
          .pluck("coastParent")
          .pluck("id")
          .uniq()
          .reject(function (n) {
            return (
              n == this.Territory.coastParent.id || n == AgainstTerritory.id
            );
          }, this);
      },
      ...
      getConvoyToChoices: function () {
        if (this.convoyLink) return this.ConvoyGroup.Coasts.pluck("id");
        else return [];
      },
      ...
      getConvoyFromChoices: function (ToTerritory) {
        if (this.convoyLink) {
          this.convoyOptions = this.ConvoyGroup.Armies.select(function (
            ConvoyArmy
          ) {
            if (ToTerritory == ConvoyArmy.Territory) return false;

            var path = ToTerritory.ConvoyGroup.pathArmyToCoastWithFleet(
              ConvoyArmy.Territory,
              ToTerritory,
              this.Territory
            );
    ...
    TerritoryClass.addMethods({
       ...
       */
      getMaxRank: function () {
        if (this.hasPath()) return this.path.getRank();
        else
      ...
      getValidBorderTerritories: function () {
        if (this.validBorderTerritoriesCache === null)
          this.validBorderTerritoriesCache = this.Borders.select(function (b) {
            return b.f;
          })
            .pluck("id")
            .compact()
      ...
      findPath: function (forceInternalNode) {
        ...
        while (testPaths.length > 0) {
          ...
          if (
            ...
            !(Object.isUndefined(this.fAllNode) || this.fAllNode(testPath.node))
          ) {
            continue;
          }
    ...
    var PathClass = Class.create({
      ...
      setComplete: function (nextNode) {
        ...
        if (this.pathToNode === null) this.setRank(0); //assure, the rank is set to 0 if this node is the start

        if (
          !Object.isUndefined(nextNode) &&
          this.pathNextNodes.indexOf(nextNode) === -1
        ) {
      ...
      getLastPathNode: function () {
        ...
        else return this.pathNextNodes[0].getLastPathNode();
      },
      ...
      searchAlternativeRoutes: function (fEndNode) {
        ...
        if (!this.alternativeChecked) {
          if (
            ...
            var alternativeRouteSearch = new PathSearchClass(
      ...
      toArray: function (array) {
        ...
        if (this.pathToNode != null) return this.pathToNode.toArray(array);
        else return array;
      },
      getLength: function () {
      ...
      //DEBUGGING ONLY
      getFirst: function () {
        if (this.pathToNode === null) return this;
        else return this.pathToNode.getFirst();
      },
    ...
    var NodeSetClass = Class.create({
      ...
      routeSetStart: function (StartTerr, fEndNode, fAllNode, fAnyNode) {
        ...
        if (AnyNodes.length == 1) {
          ...
          if (Object.isUndefined(EndTerr)) return false;
          ...
          if (!search.findPath()) return false;

          // second path
          var search2 = new PathSearchClass(EndTerr, fMiddleNode);

          if (!search2.findPath()) return false;
    ...
    ConvoyGroupClass = Class.create({
      ...
      pathArmyToCoastWithoutFleet: function (
        StartTerr,
        EndTerr,
        WithoutFleetTerr
      ) {
      ...
      loadCoasts: function () {
        this.Fleets.values()
          .pluck("Territory")
          .map(function (sea) {
            sea.getBorderTerritories().map(function (c) {
              if (c.type != "Coast") return;
              c = c.coastParent;

              if (!Object.isUndefined(this.Coasts.get(c.id))) return;

              if (Object.isUndefined(c.ConvoyGroups)) c.ConvoyGroups = [];
