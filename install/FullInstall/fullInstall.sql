...
ALTER TABLE wD_AccessLog ADD COLUMN ipv6 BINARY(16) NULL;
...
ALTER TABLE wD_Games ADD `minimumNMRScore` tinyint(3) unsigned NOT NULL DEFAULT 0;
ALTER TABLE wD_Backup_Games ADD `minimumNMRScore` tinyint(3) unsigned NOT NULL DEFAULT 0;