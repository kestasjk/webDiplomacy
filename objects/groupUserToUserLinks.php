...
require_once(l_r('objects/groupUserToUserLink.php'));
...
class GroupUserToUserLinks
{
	...
	{
		return new GroupUserToUserLinks(self::load("l.toUserID IN (SELECT userID FROM wD_GroupUsers WHERE groupID = ".$groupID.")"));
	}
	public static function loadFromUserID($userID)
	{
		return new GroupUserToUserLinks(self::load("l.toUserID = ".$userID));
	}
