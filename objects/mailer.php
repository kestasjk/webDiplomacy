...
class Mailer
{
	...
	public function __construct()
	{
		...
		elseif ( !Config::$mailerConfig["UseMail"] )
			trigger_error("No mailer type chosen; either sendmail, smtp, or mail need to be selected for e-mailing.");
	}
	...
	public function Send(array $to, $title, $message)
	{
		if( $this->useDebug )
		{
			print '<p>Mailed "<em>&lt;'.implode('&gt;, &lt;',$to).'&gt;</em>": <b>'.$title.'</b> - '.$message.'</p>';
			return;
		}

		$title = 'webDiplomacy: '.$title.' (no reply)';
...
<p style='color:#555'>Kind regards,<br />
".Config::$mailerConfig['FromName']."</p>

<p>
<img src='http://webdiplomacy.net/images/webDiplomacy.png' alt='webDiplomacy' />
</p>

<p style='font-size:90%; font-style:italic; color:#555'>
This message was generated by a webDiplomacy server, sent from
".Config::$mailerConfig['From']." to ".$email." (".$name.") at ".gmdate("Y-m-d\TH:i:s\Z")." (GMT+0), on behalf of
".htmlentities($_SERVER['REMOTE_ADDR']).".<br /><br />

If this e-mail was unexpected it can be ignored, please don't reply.<br />
If you repeatedly get unexpected / unwanted e-mails from this address please contact the server admin at
<a href='mailto:".Config::$adminEMail."'>".Config::$adminEMail."</a> to have the matter investigated.
</p>
";
