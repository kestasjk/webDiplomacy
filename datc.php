...
libHTML::starthtml('DATC Tests');

print libHTML::pageTitle('Diplomacy Adjudicator Test Cases','The results of a set of automated tests which show the webDiplomacy\'s compliance with the official Diplomacy rules.');

if ( $Misc->Maintenance )
{
	require_once('datc/interactive.php');
...
$sections=array(
	...
	8=>array('webDip intro','webDiplomacy introduction image generating tests'),
	9=>array('webDip tests','webDiplomacy specific test cases')
);
print '<ul>';
