...
<h4 class="scoring-h">Draw-Size Scoring (DSS)</h4>
...
<h4 class="scoring-h">Sum-of-Squares Scoring (SoS)</h4>
<p class="intro">
...
<h4 class="scoring-h">Unranked Games</h4>
<p class="intro">
...
<h4 class="scoring-h">Unsupported Scoring Systems</h4>
<p class="intro">
...
<h3 class="points-title">Points on webDiplomacy</h3>
