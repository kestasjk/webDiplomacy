...
<div id="points-scoring">
	...
	<h3 class="points-title" name="points">Points on webDiplomacy</h3>
	...
	<h3 class="points-title">webDiplomacy's Scoring Systems</h3>
	...
	<h4 class="scoring-h" name="DSS">Draw-Size Scoring (DSS)</h4>
	<h5>Previously known as Winner-Takes-All (WTA).</h5>			
	<p class="intro">
	...
	<h4 class="scoring-h" name="SoS">Sum-of-Squares Scoring (SoS)</h4>
	<p class="intro">
	...
	<h4 class="scoring-h" name="unranked">Unranked Games</h4>
	<p class="intro">
	...
	<h4 class="scoring-h" name="ppsc">Points-Per-Supply-Center</h4>
	<p class="intro">
