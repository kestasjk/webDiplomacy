...
class ClassicMilanVariant extends WDVariant {
	public $id         = 10;
	public $mapID      = 10;
	public $name       = 'ClassicMilan';
	public $fullName   = 'Classic - Milan Diplomacy';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['adjudicatorPreGame'] = 'ClassicMilan';
		$this->variantClasses['drawMap']            = 'ClassicMilan';
	}
