<?php
// This is file installs the map data for the Economic variant
...
$territoryRawData=array(
	...
	array('Paris', 'Land', 'Yes', 336, 620, 180, 233, 'France'),
	...
	array('Cattle', 'Land', 'Yes', 32, 1037, 15, 416, 'England'),
	array('Tea', 'Land', 'Yes', 32, 1087, 15, 441, 'Neutral'),
	array('Wool', 'Land', 'Yes', 32, 1137, 15, 466, 'Neutral'),
	array('Ships', 'Land', 'Yes', 32, 1187, 15, 491, 'Neutral'),
	array('Barley', 'Land', 'Yes', 160, 1037, 80, 416, 'France'),
	array('Cheese', 'Land', 'Yes', 160, 1087, 80, 441, 'Neutral'),
	array('Wood', 'Land', 'Yes', 160, 1137, 80, 466, 'Neutral'),
	array('Iron', 'Land', 'Yes', 160, 1187, 80, 491, 'Neutral'),
	array('Vegetables', 'Land', 'Yes', 288, 1037, 144, 416, 'Italy'),
	array('Wine', 'Land', 'Yes', 288, 1087, 144, 441, 'Neutral'),
	array('Glass', 'Land', 'Yes', 288, 1137, 144, 466, 'Neutral'),
	array('Sulfur', 'Land', 'Yes', 288, 1187, 144, 491, 'Neutral'),
	array('Pork', 'Land', 'Yes', 416, 1037, 208, 416, 'Germany'),
	array('Chemicals', 'Land', 'Yes', 416, 1087, 208, 441, 'Neutral'),
	array('Coal', 'Land', 'Yes', 416, 1137, 208, 466, 'Neutral'),
	array('Steel', 'Land', 'Yes', 416, 1187, 208, 491, 'Neutral'),
	array('Wheat', 'Land', 'Yes', 544, 1037, 272, 416, 'Austria'),
	array('Beer', 'Land', 'Yes', 544, 1087, 272, 441, 'Neutral'),
	array('Krystal', 'Land', 'Yes', 544, 1137, 272, 466, 'Neutral'),
	array('Gunpowder', 'Land', 'Yes', 544, 1187, 272, 491, 'Neutral'),
	array('Rye', 'Land', 'Yes', 672, 1037, 336, 416, 'Russia'),
	array('Vodka', 'Land', 'Yes', 672, 1087, 336, 441, 'Neutral'),
	array('Gas', 'Land', 'Yes', 672, 1137, 336, 466, 'Neutral'),
	array('Oil', 'Land', 'Yes', 672, 1187, 336, 491, 'Neutral'),
	array('Rice', 'Land', 'Yes', 800, 1037, 400, 416, 'Turkey'),
	array('Spices', 'Land', 'Yes', 800, 1087, 400, 441, 'Neutral'),
	array('Cotton', 'Land', 'Yes', 800, 1137, 400, 466, 'Neutral'),
	array('Silk', 'Land', 'Yes', 800, 1187, 400, 491, 'Neutral')
);
...
$bordersRawData=array(
	...
	array('Cattle','Tea','No','Yes'),
	array('Cattle','Barley','No','Yes'),
	array('Tea','Cattle','No','Yes'),
	array('Tea','Wool','No','Yes'),
	array('Tea','Cheese','No','Yes'),
	array('Wool','Tea','No','Yes'),
	array('Wool','Ships','No','Yes'),
	array('Ships','Wool','No','Yes'),
	array('Ships','Iron','No','Yes'),
	array('Barley','Cattle','No','Yes'),
	array('Barley','Cheese','No','Yes'),
	array('Cheese','Tea','No','Yes'),
	array('Cheese','Barley','No','Yes'),
	array('Cheese','Wood','No','Yes'),
	array('Cheese','Wine','No','Yes'),
	array('Wood','Cheese','No','Yes'),
	array('Wood','Iron','No','Yes'),
	array('Wood','Glass','No','Yes'),
	array('Iron','Ships','No','Yes'),
	array('Iron','Wood','No','Yes'),
	array('Iron','Sulfur','No','Yes'),
	array('Vegetables','Wine','No','Yes'),
	array('Vegetables','Pork','No','Yes'),
	array('Wine','Cheese','No','Yes'),
	array('Wine','Vegetables','No','Yes'),
	array('Wine','Glass','No','Yes'),
	array('Wine','Chemicals','No','Yes'),
	array('Glass','Wood','No','Yes'),
	array('Glass','Wine','No','Yes'),
	array('Glass','Sulfur','No','Yes'),
	array('Sulfur','Iron','No','Yes'),
	array('Sulfur','Glass','No','Yes'),
	array('Sulfur','Steel','No','Yes'),
	array('Pork','Vegetables','No','Yes'),
	array('Pork','Chemicals','No','Yes'),
	array('Pork','Wheat','No','Yes'),
	array('Chemicals','Wine','No','Yes'),
	array('Chemicals','Pork','No','Yes'),
	array('Chemicals','Coal','No','Yes'),
	array('Chemicals','Beer','No','Yes'),
	array('Coal','Chemicals','No','Yes'),
	array('Coal','Steel','No','Yes'),
	array('Steel','Sulfur','No','Yes'),
	array('Steel','Coal','No','Yes'),
	array('Steel','Gunpowder','No','Yes'),
	array('Wheat','Pork','No','Yes'),
	array('Wheat','Beer','No','Yes'),
	array('Beer','Chemicals','No','Yes'),
	array('Beer','Wheat','No','Yes'),
	array('Beer','Krystal','No','Yes'),
	array('Beer','Vodka','No','Yes'),
	array('Krystal','Beer','No','Yes'),
	array('Krystal','Gunpowder','No','Yes'),
	array('Krystal','Gas','No','Yes'),
	array('Gunpowder','Steel','No','Yes'),
	array('Gunpowder','Krystal','No','Yes'),
	array('Gunpowder','Oil','No','Yes'),
	array('Rye','Vodka','No','Yes'),
	array('Rye','Rice','No','Yes'),
	array('Vodka','Beer','No','Yes'),
	array('Vodka','Rye','No','Yes'),
	array('Vodka','Gas','No','Yes'),
	array('Vodka','Spices','No','Yes'),
	array('Gas','Krystal','No','Yes'),
	array('Gas','Vodka','No','Yes'),
	array('Gas','Oil','No','Yes'),
	array('Oil','Gunpowder','No','Yes'),
	array('Oil','Gas','No','Yes'),
	array('Oil','Silk','No','Yes'),
	array('Rice','Rye','No','Yes'),
	array('Rice','Spices','No','Yes'),
	array('Spices','Vodka','No','Yes'),
	array('Spices','Rice','No','Yes'),
	array('Spices','Cotton','No','Yes'),
	array('Cotton','Spices','No','Yes'),
	array('Cotton','Silk','No','Yes'),
	array('Silk','Oil','No','Yes'),
	array('Silk','Cotton','No','Yes')
);
