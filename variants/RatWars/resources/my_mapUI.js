...
function loadMap(verify, gameID, currentTurn, newTurn)
{
	...
	$('LargeMapLink').innerHTML = 
			' <a href="variants/RatWars/resources/fogmap.php?gameID='+gameID+'&turn='+newTurn+'&verify='+verify+'&mapType=large" target="blank" class="light">'+
	...
	$('mapImage').src = 'variants/RatWars/resources/fogmap.php?verify='+verify+'&gameID='+gameID+'&turn='+newTurn;
}