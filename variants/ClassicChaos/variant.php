...
class ClassicChaosVariant extends WDVariant {
	public $id         =17;
	public $mapID      =17;
	public $name       ='ClassicChaos';
	public $fullName   ='Classic - Chaos';
	...
	public function __construct() {
		...
		$this->variantClasses['drawMap']            = 'ClassicChaos';
		$this->variantClasses['adjudicatorPreGame'] = 'ClassicChaos';
		$this->variantClasses['OrderInterface']     = 'ClassicChaos';
		$this->variantClasses['processGame']        = 'ClassicChaos';
		$this->variantClasses['userOrderBuilds']    = 'ClassicChaos';
		$this->variantClasses['processOrderBuilds'] = 'ClassicChaos';
		$this->variantClasses['Chatbox']            = 'ClassicChaos';
		$this->variantClasses['panelMembersHome']   = 'ClassicChaos';
	}
