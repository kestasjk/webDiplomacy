...
class GermanyVsRussiaVariant_adjudicatorPreGame extends adjudicatorPreGame {

	protected $countryUnits = array(
		'Germany'  => array('Kiel'  =>'Fleet', 'Munich' =>'Army', 'Berlin'=>'Army'),
		'Russia' => array('St. Petersburg (South Coast)'=>'Fleet', 'Moscow'=>'Army', 'Warsaw'  =>'Army', 'Sevastopol'=>'Fleet')
	);
