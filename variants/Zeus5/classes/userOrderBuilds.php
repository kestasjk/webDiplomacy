...
class AlternateBuildSC_userOrderBuilds extends userOrderBuilds {

	protected function toTerrIDCheck()
	{
		if ((int)$this->toTerrID == 13 && (int)$this->countryID == 2) return true;
		return parent::toTerrIDCheck();
	}

}

class Zeus5Variant_userOrderBuilds extends AlternateBuildSC_userOrderBuilds {}
