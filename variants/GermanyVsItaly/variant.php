...
class GermanyVsItalyVariant extends WDVariant {
	public $id         =23;
	public $mapID      =23;
	public $name       ='GermanyVsItaly';
	public $fullName   ='Germany vs Italy';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']            = 'GermanyVsItaly';
		$this->variantClasses['adjudicatorPreGame'] = 'GermanyVsItaly';
		$this->variantClasses['processMember']      = 'GermanyVsItaly';
	}
