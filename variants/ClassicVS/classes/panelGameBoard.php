...
class CustomCountries_panelGameBoard extends panelGameBoard
{
	function contentHeader()
	{
		return $this->Variant->css_restyle(parent::contentHeader());
	}
...
class ClassicVSVariant_panelGameBoard extends CustomCountries_panelGameBoard {}
