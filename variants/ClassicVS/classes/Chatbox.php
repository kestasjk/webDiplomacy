...
class CustomCountries_Chatbox extends Chatbox
{
	public function output($msgCountryID)
	{
		global $Variant;
		return $Variant->css_restyle(parent::output($msgCountryID));	
	}
}

class ClassicVSVariant_Chatbox extends CustomCountries_Chatbox {}
