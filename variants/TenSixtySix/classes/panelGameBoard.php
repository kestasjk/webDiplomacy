...
class Fog_panelGameBoard extends panelGameBoard
{
	...
	function mapHTML() {
		...
		if (!(file_exists($newFile)))
			$newFile='variants/TenSixtySix/resources/fogmap.php?&verify='.$verify.'&gameID='.$this->id.'&turn='.$mapTurn;
		$oldMap="map.php?";
		$newMap="variants/TenSixtySix/resources/fogmap.php?verify=".$verify."&";
	...
	protected function mapJS($mapTurn) {
		...
		libHTML::$footerIncludes[] = '../variants/TenSixtySix/resources/my_mapUI.js';
	}
