...
class Fog_Maps extends Maps
{
	...
	{
		return str_replace("map.php?" ,"variants/TenSixtySix/resources/fogmap.php?verify=".$this->verify."&" , parent::mapHTML($turn));
	}
...
class TenSixtySixVariant_Maps extends Fog_Maps {}
