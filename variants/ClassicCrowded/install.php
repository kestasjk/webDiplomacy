<?php
// This file will install the map data for the Crowded variant
...
$territoryRawData=array(
	...
	array('Portugal', 'Coast', 'Yes', 100, 718, 65, 292, 'Spain'),
	...
	array('North Africa', 'Coast', 'No', 210, 923, 130, 380, 'Spain'),
	array('Tunis', 'Coast', 'Yes', 420, 970, 204, 384, 'Spain'),
	...
	array('Greece', 'Coast', 'Yes', 676, 851, 355, 361, 'Balkan'),
	array('Albania', 'Coast', 'No', 640, 820, 343, 341, 'Balkan'),
	array('Serbia', 'Land', 'Yes', 668, 766, 357, 324, 'Balkan'),
	array('Bulgaria', 'Coast', 'Yes', 730, 776, 394, 318, 'Balkan'),
	array('Bulgaria (North Coast)', 'Coast', 'No', 785, 762, 424, 304, 'Balkan'),
	array('Bulgaria (South Coast)', 'Coast', 'No', 749, 815, 397, 332, 'Balkan'),
	array('Rumania', 'Coast', 'Yes', 765, 717, 412, 272, 'Balkan'),
	...
	array('Sweden', 'Coast', 'Yes', 587, 285, 307, 103, 'Norway'),
	array('Norway', 'Coast', 'Yes', 518, 270, 265, 113, 'Norway'),
	array('Denmark', 'Coast', 'Yes', 501, 435, 264, 150, 'Norway'),
	...
	array('Ruhr', 'Land', 'Yes', 450, 550, 227, 221, 'Lowland'),
	array('Holland', 'Coast', 'Yes', 433, 510, 234, 185, 'Lowland'),
	array('Belgium', 'Coast', 'Yes', 410, 550, 215, 205, 'Lowland'),
