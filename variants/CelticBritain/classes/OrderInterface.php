...
/*
	...
	This file is part of the Celtic Britain variant for webDiplomacy

	The Celtic Britain variant for webDiplomacy is free software: you can redistribute
	it and/or modify it under the terms of the GNU Affero General Public License 
	as published by the Free Software Foundation, either version 3 of the License,
	or (at your option) any later version.

	The Celtic Britain variant for webDiplomacy is distributed in the hope that it will be
...
class CoastConvoy_OrderInterface extends CustomIcons_OrderInterface
{
	protected function jsLoadBoard()
	{
		global $Variant;
...
class CelticBritainVariant_OrderInterface extends CoastConvoy_OrderInterface {}