...
class ClassicFGvsRTVariant extends WDVariant {
	public $id         =26;
	public $mapID      =26;
	public $name       ='ClassicFGvsRT';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']            = 'ClassicFGvsRT';
		$this->variantClasses['adjudicatorPreGame'] = 'ClassicFGvsRT';
	}
