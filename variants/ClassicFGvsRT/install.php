...
/**
 * Installs Classic map data (copied from the classic map)
 */
...
$territoryRawData=array(
	array('Clyde'                       ,'Coast','No' ,309 ,337,157,120,'Neutral','No')    ,
	array('Edinburgh'                   ,'Coast','Yes',340 ,350,175,109,'Neutral','No')    ,
	array('Liverpool'                   ,'Coast','Yes',315 ,405,166,140,'Neutral','No')    ,
	array('Yorkshire'                   ,'Coast','No' ,355 ,440,184,150,'Neutral','No')    ,
	array('Wales'                       ,'Coast','No' ,305 ,480,154,179,'Neutral','No')    ,
	array('London'                      ,'Coast','Yes',358 ,485,176,185,'Neutral','No')    ,
	array('Portugal'                    ,'Coast','Yes',100 ,718,65 ,292,'Neutral','No')    ,
	array('Spain'                       ,'Coast','Yes',205 ,760,110,307,'Neutral','Parent'),
	array('Spain (North Coast)'         ,'Coast','No' ,193 ,685,90 ,273,'Neutral','North') ,
	array('Spain (South Coast)'         ,'Coast','No' ,191 ,832,106,345,'Neutral','South') ,
	array('North Africa'                ,'Coast','No' ,210 ,923,130,380,'Neutral','No')    ,
	array('Tunis'                       ,'Coast','Yes',420 ,970,204,384,'Neutral','No')    ,
	array('Naples'                      ,'Coast','Yes',570 ,870,298,357,'Neutral','No')    ,
	array('Rome'                        ,'Coast','Yes',522 ,800,272,330,'Neutral','No')    ,
	array('Tuscany'                     ,'Coast','No' ,485 ,755,256,312,'Neutral','No')    ,
	array('Piedmont'                    ,'Coast','No' ,441 ,694,228,276,'Neutral','No')    ,
	array('Venice'                      ,'Coast','Yes',490 ,710,258,292,'Neutral','No')    ,
	array('Apulia'                      ,'Coast','No' ,575 ,813,295,335,'Neutral','No')    ,
	array('Greece'                      ,'Coast','Yes',676 ,851,355,361,'Neutral','No')    ,
	array('Albania'                     ,'Coast','No' ,640 ,820,343,341,'Neutral','No')    ,
	array('Serbia'                      ,'Land' ,'Yes',668 ,766,357,324,'Neutral','No')    ,
	array('Bulgaria'                    ,'Coast','Yes',730 ,776,394,318,'Neutral','Parent'),
	array('Bulgaria (North Coast)'      ,'Coast','No' ,785 ,762,424,304,'Neutral','North') ,
	array('Bulgaria (South Coast)'      ,'Coast','No' ,749 ,815,397,332,'Neutral','South') ,
	array('Rumania'                     ,'Coast','Yes',765 ,717,412,272,'Neutral','No')    ,
	array('Constantinople'              ,'Coast','Yes',821 ,840,433,345,'Juggernaut','No')    ,
	array('Smyrna'                      ,'Coast','Yes',899 ,890,480,363,'Juggernaut','No')    ,
	array('Ankara'                      ,'Coast','Yes',970 ,820,485,320,'Juggernaut','No')    ,
	array('Armenia'                     ,'Coast','No' ,1130,835,572,323,'Juggernaut','No')    ,
	array('Syria'                       ,'Coast','No' ,1073,940,559,370,'Juggernaut','No')    ,
	array('Sevastopol'                  ,'Coast','Yes',920 ,595,485,248,'Juggernaut','No')    ,
	array('Ukraine'                     ,'Land' ,'No' ,779 ,579,418,220,'Juggernaut','No')    ,
	array('Warsaw'                      ,'Land' ,'Yes',680 ,540,358,209,'Juggernaut','No')    ,
	array('Livonia'                     ,'Coast','No' ,719 ,441,374,168,'Juggernaut','No')    ,
	array('Moscow'                      ,'Land' ,'Yes',880 ,440,490,160,'Juggernaut','No')    ,
	array('St. Petersburg'              ,'Coast','Yes',837 ,309,445,97 ,'Juggernaut','Parent'),
	array('St. Petersburg (North Coast)','Coast','No' ,828 , 90,448,59 ,'Juggernaut','North') ,
	array('St. Petersburg (South Coast)','Coast','No' ,760 ,335,397,130,'Juggernaut','South') ,
	array('Finland'                     ,'Coast','No' ,710 ,263,369,109,'Juggernaut','No')    ,
	array('Sweden'                      ,'Coast','Yes',587 ,285,307,103,'Neutral','No')    ,
	array('Norway'                      ,'Coast','Yes',518 ,270,265,113,'Neutral','No')    ,
	array('Denmark'                     ,'Coast','Yes',501 ,435,264,150,'Neutral','No')    ,
	array('Kiel'                        ,'Coast','Yes',477 ,504,253,193,'Frankland','No')    ,
	array('Berlin'                      ,'Coast','Yes',559 ,493,287,189,'Frankland','No')    ,
	array('Prussia'                     ,'Coast','No' ,618 ,482,319,202,'Frankland','No')    ,
	array('Silesia'                     ,'Land' ,'No' ,589 ,535,315,222,'Frankland','No')    ,
	array('Munich'                      ,'Land' ,'Yes',489 ,596,252,229,'Frankland','No')    ,
	array('Ruhr'                        ,'Land' ,'No' ,450 ,550,227,221,'Frankland','No')    ,
	array('Holland'                     ,'Coast','Yes',433 ,510,234,185,'Neutral','No')    ,
	array('Belgium'                     ,'Coast','Yes',410 ,550,215,205,'Neutral','No')    ,
	array('Picardy'                     ,'Coast','No' ,363 ,559,182,213,'Frankland' ,'No')    ,
	array('Brest'                       ,'Coast','Yes',298 ,595,153,240,'Frankland' ,'No')    ,
	array('Paris'                       ,'Land' ,'Yes',336 ,620,176,233,'Frankland' ,'No')    ,
	array('Burgundy'                    ,'Land' ,'No' ,393 ,629,204,243,'Frankland' ,'No')    ,
	array('Marseilles'                  ,'Coast','Yes',390 ,689,199,275,'Frankland' ,'No')    ,
	array('Gascony'                     ,'Coast','No' ,301 ,676,154,265,'Frankland' ,'No')    ,
	array('Barents Sea'                 ,'Sea'  ,'No' ,826 ,37 ,427,15 ,'Neutral','No')    ,
	array('Norwegian Sea'               ,'Sea'  ,'No' ,437 ,149,240,31 ,'Neutral','No')    ,
	array('North Sea'                   ,'Sea'  ,'No' ,414 ,378,216,125,'Neutral','No')    ,
	array('Skagerrack'                  ,'Sea'  ,'No' ,518 ,363,284,146,'Neutral','No')    ,
	array('Heligoland Bight'            ,'Sea'  ,'No' ,455 ,439,241,159,'Neutral','No')    ,
	array('Baltic Sea'                  ,'Sea'  ,'No' ,621 ,431,338,177,'Neutral','No')    ,
	array('Gulf of Bothnia'             ,'Sea'  ,'No' ,653 ,330,345,141,'Neutral','No')    ,
	array('North Atlantic Ocean'        ,'Sea'  ,'No' ,145 ,250,78 ,92 ,'Neutral','No')    ,
	array('Irish Sea'                   ,'Sea'  ,'No' ,208 ,478,118,171,'Neutral','No')    ,
	array('English Channel'             ,'Sea'  ,'No' ,275 ,526,145,205,'Neutral','No')    ,
	array('Mid-Atlantic Ocean'          ,'Sea'  ,'No' ,106 ,587,60 ,251,'Neutral','No')    ,
	array('Western Mediterranean'       ,'Sea'  ,'No' ,327 ,852,186,350,'Neutral','No')    ,
	array('Gulf of Lyons'               ,'Sea'  ,'No' ,366 ,774,208,322,'Neutral','No')    ,
	array('Tyrrhenian Sea'              ,'Sea'  ,'No' ,480 ,847,248,343,'Neutral','No')    ,
	array('Ionian Sea'                  ,'Sea'  ,'No' ,610 ,952,325,379,'Neutral','No')    ,
	array('Adriatic Sea'                ,'Sea'  ,'No' ,554 ,761,316,329,'Neutral','No')    ,
	array('Aegean Sea'                  ,'Sea'  ,'No' ,755 ,930,395,363,'Neutral','No')    ,
	array('Eastern Mediterranean'       ,'Sea'  ,'No' ,860 ,967,465,383,'Neutral','No')    ,
	array('Black Sea'                   ,'Sea'  ,'No' ,915 ,735,457,300,'Neutral','No')    ,
	array('Tyrolia'                     ,'Land' ,'No' ,542 ,632,282,252,'Neutral','No')    ,
	array('Bohemia'                     ,'Land' ,'No' ,567 ,586,298,227,'Neutral','No')    ,
	array('Vienna'                      ,'Land' ,'Yes',602 ,637,314,246,'Neutral','No')    ,
	array('Trieste'                     ,'Coast','Yes',579 ,710,308,288,'Neutral','No')    ,
	array('Budapest'                    ,'Land' ,'Yes',661 ,678,350,260,'Neutral','No')    ,
	array('Galicia'                     ,'Land' ,'No' ,710 ,610,378,240,'Neutral','No')
);
