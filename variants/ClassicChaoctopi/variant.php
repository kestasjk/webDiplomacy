...
class ClassicChaoctopiVariant extends WDVariant {
	public $id         =54;
	public $mapID      =54;
	public $name       ='ClassicChaoctopi';
	public $fullName   ='Classic - Chaoctopi';
	...
	public function __construct() {
		...
		$this->variantClasses['drawMap']            = 'ClassicChaoctopi';
		$this->variantClasses['adjudicatorPreGame'] = 'ClassicChaoctopi';
		$this->variantClasses['OrderInterface']     = 'ClassicChaoctopi';
		$this->variantClasses['processGame']        = 'ClassicChaoctopi';
		$this->variantClasses['userOrderBuilds']    = 'ClassicChaoctopi';
		$this->variantClasses['processOrderBuilds'] = 'ClassicChaoctopi';
		$this->variantClasses['Chatbox']            = 'ClassicChaoctopi';
		$this->variantClasses['panelMembersHome']   = 'ClassicChaoctopi';
	}
