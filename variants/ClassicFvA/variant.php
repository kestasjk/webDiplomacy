...
class ClassicFvAVariant extends WDVariant {
	public $id         =15;
	public $mapID      =15;
	public $name       ='ClassicFvA';
	public $fullName   ='Classic - France vs Austria';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']               = 'ClassicFvA';
		$this->variantClasses['adjudicatorPreGame']    = 'ClassicFvA';
	}
