...
class ClassicFGAVariant extends WDVariant {
	public $id         =48;
	public $mapID      =48;
	public $name       ='ClassicFGA';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']               = 'ClassicFGA';
		$this->variantClasses['adjudicatorPreGame']    = 'ClassicFGA';
	}
