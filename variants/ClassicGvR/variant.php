...
class ClassicGvRVariant extends WDVariant {
	public $id         =25;
	public $mapID      =25;
	public $name       ='ClassicGvR';
	public $fullName   ='Classic - Germany vs Russia';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']            = 'ClassicGvR';
		$this->variantClasses['adjudicatorPreGame'] = 'ClassicGvR';
	}
