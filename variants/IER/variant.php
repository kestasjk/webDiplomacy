...
class IERVariant extends WDVariant {
	public $id         =49;
	public $mapID      =49;
	public $name       ='IER';
	public $fullName   ='Italy+ Vs England+ Vs Russia';
	...
	public function __construct() {
		parent::__construct();
		$this->variantClasses['drawMap']               = 'IER';
		$this->variantClasses['adjudicatorPreGame']    = 'IER';
		$this->variantClasses['processMember']         = 'IER';
		$this->variantClasses['processOrderDiplomacy'] = 'IER';
