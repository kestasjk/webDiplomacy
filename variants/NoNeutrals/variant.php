...
class NoNeutralsVariant extends WDVariant {
	...
	public function __construct() {
		...
		$this->variantClasses['drawMap']            = 'NoNeutrals';
		$this->variantClasses['adjudicatorPreGame'] = 'NoNeutrals';
