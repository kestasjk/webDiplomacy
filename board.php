...
try
{
	...
	if( !isset($_REQUEST['sbToken']) && $Game->usePointAndClickUI() ) // TODO: Get sandbox public access tokens working with legacy UI
	{
		...
		header("Location: game/?gameID=".$gameID);

		libHTML::notice('Loading board', '<em>Loading the game board, please wait.. If you are not redirected within 5 seconds, <a href="game/?gameID='.$gameID.'">click here</a>.</em>');
