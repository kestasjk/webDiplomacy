...
{
	$message = l_t('%s is a bot account, and bots do not have profile pages; they play far too many games for this page\'s list of them to be generated.',
		htmlspecialchars($UserProfile->username, ENT_QUOTES, 'UTF-8'));
