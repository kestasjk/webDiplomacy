...
const SvgHomeIconSelected = ({iconState}) => (
  <svg
    width={40}
    height={40}
    // fill={iconState === "inactive" && "#000"}
    xmlns="http://www.w3.org/2000/svg"
    filter={iconState === "active" && "drop-shadow(-1px 12px 7px #636363)"}
  >
    {iconState === "active" && <circle cx="20" cy="20" r="20" />}
    <path
      ...
      fill="#fff"
      filter={iconState === "inactive" && "drop-shadow(.5px 2px 6px #404040)"}
    />
  </svg>
);
