...
import WDUnitController from "../ui/WDUnitController";
  ...
  return (
    ...
    >
      <WDUnitController meta={meta} setIconState={setFluidIconState}>
        ...
        {fluidIconState === UIState.SELECTED && (
          <path
        ...
        {fluidIconState === UIState.DISBANDED && (
          <>
            <path
        ...
        {fluidIconState !== UIState.DISBANDED && (
          <path
            ...
            fill={
              fluidIconState === "selected"
                ? "#fff"
                : theme.palette[country].main
            }
          />
        )}
      </WDUnitController>
